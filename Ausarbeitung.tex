...
l		Jetzt folgt das erste Beispiel
	...
	\end{tikzcd}
	 ...
	 \begin{bsp}[Datenbanken]
		 ...
		 %diagram_database
		 	\begin{tikzcd}
		Mitarbeiter
		\arrow[loop, bend left=10, "Manager" ]{}
	...
	\section{Isomorphismen}
		...
		%diagram_isomorph_objects
			\begin{tikzcd}[
		]
		A 
		\arrow[r, bend left=30,"f"]{}
		\arrow[r, swap,bend right=30,"{f^{-1}}"  ]{}
		& 
		B 
	\end{tikzcd}
	...
	\section{Kommutative Diagramme}
		...
		Als Spezialfall hiervon kann man kommutative Dreiecke und Quadrate betrachten:
 		%diagram_dreieck_easy
 			\begin{tikzcd}[
		]
		A \ar{rr}{f} \ar{dr}[swap]{g} 
		&
		& 
		B \arrow[dl,leftarrow, dashed, "\exists"]{}\\
		&
		C
		&
	\end{tikzcd}
		%diagram_quadrat_easy
			\begin{tikzcd}[
	]
	\bullet 
	\arrow[r]{}
...
Es gibt auch noch weitere Arten der Konstruktion wie \"Uber-A-Kategorie oder Kategorien von Wirkungen, jedoch werde ich auf diese nicht in meiem Vortrag eingehen.
