...
\section{Einleitung}
	...
	\\
	Im folgenden Teil werde ich einige Definitionen liefern und sie hoffentlich mit den Beispielen von der N\"utzlichkeit der Defininitionen \"uberzeugen k\"onnen. Der Aufbau folgt der Sortierung der Quelle. \nocite{Bra}
...
l		Jetzt beginnen wir mit einem Beispiel
	...
	(\cite[Beispiel 2.2.10]{Bra}):
	 ...
	 \begin{bsp}[Datenbanken]
		 ...
		 \includestandalone[width=.7\linewidth]{./files/diagrams/diagram_database} \\
