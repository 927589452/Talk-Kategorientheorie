...
l		Jetzt folgt das erste Beispiel
	...
	(\cite[Beispiel 2.2.10]{Bra}):
		...
		\begin{bsp}
		 ...
		 Ein Morphismus \(x   \to y \) existiert, wenn \( x \vert y\) \\
		  ...
		  %\includestandalone
		  \include{./files/diagrams/diagram_teiler_6} 
		\end{bsp} 
	 ...
	 \begin{bsp}[Datenbanken]
		 ...
		 %\includestandalone
		 \include{./files/diagrams/diagram_database}
	...
	\section{Isomorphismen}
		...
		%\includestandalone
		\include{files/diagrams/diagram_isomorph_objects}
	...
	Eine \emph{Faktorisierung} eines Morphismus \( f:A \to B \) ist ein kommutatives Diagramm \\
		%\includestandalone{
		\input{./files/diagrams/diagram_dreieck_faktor} \\
...
\end{defi}
	...
	\begin{bsp}
	%\includestandalone{
	\input{./files/diagrams/diagram_teiler_6}
...
%	\includestandalote{
	\input{./files/diagrams/diagram_teiler_6}
%	\includestandalone{
	\input{./files/diagrams/diagram_teiler_6_dual}
